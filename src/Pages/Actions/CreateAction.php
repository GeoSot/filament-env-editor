...
class CreateAction extends \Filament\Actions\CreateAction
{
    protected function setUp(): void
    {
        ...
        $this->label(fn (): string => __('filament-env-editor::filament-env-editor.page.actions.add.title'));
        $this->modalHeading(fn (
        ): string => __('filament-env-editor::filament-env-editor.page.actions.add.modalHeading'));

        $this->form([
            TextInput::make('key')
                ->label(__('filament-env-editor::filament-env-editor.page.actions.add.form.fields.key'))
                ->required(),
            TextInput::make('value')
                ->label(__('filament-env-editor::filament-env-editor.page.actions.add.form.fields.value')),
            Select::make('index')
                ->label(__('filament-env-editor::filament-env-editor.page.actions.add.form.fields.index'))
                ->helperText(__('filament-env-editor::filament-env-editor.page.actions.add.form.helpText.index'))
        ...
        $this->action(function (array $data, ViewEnv $page) {
            ...
            try {
                ...
                ): string => __('filament-env-editor::filament-env-editor.page.actions.add.success.title',
                    ['name' => $data['key']]));
